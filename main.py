...
def get_parser():
    ...
    parser.add_argument('--dataset_root', type=str, default='/home/mvries/Documents/Datasets/', help="Dataset root path")
    ...
    parser.add_argument('--output_dir', type=str, default='', metavar='N',
